...
if mensajeTwitter.size() > 0:
    print("Cola con notificaciones de Twitter en donde el mensaje incluya la palabra Python: ")
    mensajeTwitter.show()
print()
horarioProducido,contador_horarios=notiHorario(notificacion_queue)
if contador_horarios>0:
    print(f"Pila con las notificaciones producidas entre las 11:43 y las 15:57 con una cantidad de {contador_horarios}: ")
