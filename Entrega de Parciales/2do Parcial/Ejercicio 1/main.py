...
# ,número, tipo/tipos, debilidad frente a tipo/tipos, si tiene mega evolucion (bool) y si tiene forma gigamax (bool) para el cual debemos construir 
...
arbol_tipo.by_level()
print()
num=int(input("Ingrese un numero de pokemon para mostrar todos sus datos: "))
